angular.module('nyansync.core')
    ...
    .controller('NyanSyncController', function ($scope, $http, $location, LocaleService, Events, $filter, $q, $compile, $timeout, $rootScope, $translate) {
        'use strict';
        ...
        $scope.folderStatus = function (folderCfg) {
            ...
            // after restart nyansync process state may be empty
        ...
        $scope.nyansyncStatus = function () {
            ...
            if (!$scope.configInSync || $scope.errorList().length > 0 || !online || (
                            ...
                            $scope.restoreVersions.tree = $("#restoreTree").fancytree({
                                ...
                                renderColumns: function (event, data) {
                                    var node = data.node,
                                        ...
                                        template;
                                    if (node.folder) {
                                        template = '<div ng-include="\'nyansync/folder/restoreVersionsMassActions.html\'" class="pull-right"/>';
                                    } else {
                                        template = '<div ng-include="\'nyansync/folder/restoreVersionsVersionSelector.html\'" class="pull-right"/>';
                                    }
